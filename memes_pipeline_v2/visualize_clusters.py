...
parser.add_option("-c", "--clustering", dest='clustering',
                  default='clustering_output.txt', help="file that includes clustering output")
parser.add_option("-m", "--matrix", dest='matrix',
                  default='distance_matrix.mat', help="distances in csr_matrix format")
parser.add_option("-i", "--index", dest='index', default='index_images.p',
                  help="dictionary that includes the mapping between images and index in distance matrix")
parser.add_option("-o", "--output", dest='output',
                  default='clusters_visualization/', help="directory to put pdfs")
...
with open(inp_file, 'r') as f:
    for line in f:
        ...
        plt.suptitle("Images in cluster #" + str(cluster) +
                     " = " + str(len(images_in_cluster)), fontsize=50)
